...
//#endregion
//#region ../node_modules/.pnpm/random-seed@0.3.0/node_modules/random-seed/index.js
var require_random_seed = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var uheprng = function(seed) {
		return function() {
			...
			random.seed = function(seed) {
				if (typeof seed === "undefined" || seed === null) seed = Math.random();
				if (typeof seed !== "string") seed = stringify(seed, function(key, value) {
			...
			if (typeof seed !== "undefined") random.seed(seed);
...
//#endregion
export default require_random_seed();
