...
var _hasObjectTag_default = tagTester("Object");
//#endregion
//#region ../node_modules/.pnpm/underscore@1.13.8/node_modules/underscore/modules/_stringTagBug.js
var hasDataViewBug = supportsDataView && (!/\[native code\]/.test(String(DataView)) || _hasObjectTag_default(/* @__PURE__ */ new DataView(/* @__PURE__ */ new ArrayBuffer(8))));
var isIE11 = typeof Map !== "undefined" && _hasObjectTag_default(/* @__PURE__ */ new Map());
//#endregion
...
var _getByteLength_default = shallowProperty("byteLength");
//#endregion
//#region ../node_modules/.pnpm/underscore@1.13.8/node_modules/underscore/modules/_isBufferLike.js
var _isBufferLike_default = createSizePropertyCheck(_getByteLength_default);
//#endregion
...
var _getLength_default = shallowProperty("length");
//#endregion
...
var _isArrayLike_default = createSizePropertyCheck(_getLength_default);
//#endregion
...
var bindAll_default = restArguments(function(obj, keys) {
...
var defer_default = partial(delay_default, _$1, 1);
//#endregion
...
var once_default = partial(before, 2);
//#endregion
...
var groupBy_default = group(function(result, value, key) {
...
var pick_default = restArguments(function(obj, keys) {
...
var omit_default = restArguments(function(obj, keys) {
...
var difference_default = restArguments(function(array, rest) {
...
_._ = _;
//#endregion
export { VERSION, after, every as all, every, allKeys, some as any, some, extendOwn_default as assign, extendOwn_default as extendOwn, before, bind_default as bind, bindAll_default as bindAll, chain, chunk, clone, map as collect, map, compact, compose, constant, contains, contains as include, contains as includes, countBy_default as countBy, create, debounce, _ as default, defaults_default as defaults, defer_default as defer, delay_default as delay, find as detect, find, difference_default as difference, rest as drop, rest, rest as tail, each, each as forEach, escape_default as escape, extend_default as extend, filter, filter as select, findIndex_default as findIndex, findKey, findLastIndex_default as findLastIndex, findWhere, first, first as head, first as take, flatten, reduce_default as foldl, reduce_default as inject, reduce_default as reduce, reduceRight_default as foldr, reduceRight_default as reduceRight, functions, functions as methods, get, groupBy_default as groupBy, has, identity, indexBy_default as indexBy, indexOf_default as indexOf, initial, intersection, invert, invoke_default as invoke, isArguments_default as isArguments, isArray_default as isArray, isArrayBuffer_default as isArrayBuffer, isBoolean, isDataView_default as isDataView, isDate_default as isDate, isElement, isEmpty, isEqual, isError_default as isError, isFinite$1 as isFinite, isFunction_default as isFunction, isMap_default as isMap, isMatch, isNaN$1 as isNaN, isNull, isNumber_default as isNumber, isObject, isRegExp_default as isRegExp, isSet_default as isSet, isString_default as isString, isSymbol_default as isSymbol, isTypedArray_default as isTypedArray, isUndefined, isWeakMap_default as isWeakMap, isWeakSet_default as isWeakSet, iteratee, keys, last, lastIndexOf_default as lastIndexOf, mapObject, matcher, matcher as matches, max, memoize, min, mixin, negate, noop, now_default as now, object, omit_default as omit, once_default as once, pairs, partial, partition_default as partition, pick_default as pick, pluck, property, propertyOf, random, range, reject, restArguments, result, sample, shuffle, size, sortBy, sortedIndex, tap, template, templateSettings_default as templateSettings, throttle, times, toArray, toPath, unzip as transpose, unzip, unescape_default as unescape, union_default as union, uniq, uniq as unique, uniqueId, values, where, without_default as without, wrap, zip_default as zip };
